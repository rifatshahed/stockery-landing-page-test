...
const Pricing = () => {
    return (
        ...
        <div className='grid grid-cols-3 gap-5 ml-16 mt-16 pt-16'>
...
<div className="w-64 p-4 bg-indigo-500 shadow-lg rounded-2xl dark:bg-gray-800">
    ...
    <button type="button" className="w-full px-3 py-3 text-sm text-indigo-500 bg-white rounded-lg shadow hover:bg-gray-100 ">
        Choose plan
    </button>
</div>
